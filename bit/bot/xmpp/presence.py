...
class BotPresence(xmppim.PresenceClientProtocol):
    ...
    def subscribeReceived(self, entity):
        log.msg('bit.bot.xmpp.presence: BotPresence.subscribeReceived: ',
                entity)
        # im everybody's buddy
        self.subscribed(entity)

    def subscribedReceived(self, entity):
        log.msg('bit.bot.xmpp.presence: BotPresence.subscribedReceived: ',
                entity)
        # somebody is my buddy
        pass

    def unsubscribeReceived(self, entity):
        log.msg('bit.bot.xmpp.presence: BotPresence.unsubscribeReceived: ',
                entity)
    ...
    def availableReceived(self, entity, show=None, statuses=None, priority=0):
        log.msg('bit.bot.xmpp.presence: BotPresence.availableReceived: ',
                entity)
        # one of my buddys is online
        self.friends_online.add(entity)

    def unavailableReceived(self, entity, statuses=None):
        log.msg('bit.bot.xmpp.presence: BotPresence.unavailableReceived',
                entity)
